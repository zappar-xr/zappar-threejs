...
<!-- Added by: zapparadmin, at: Wed Jun 28 12:12:16 BST 2023 -->
...
<https://libs.zappar.com/zappar-threejs/2.4.2/zappar-threejs.zip>
...
```html
<script src="https://libs.zappar.com/zappar-threejs/2.4.2/zappar-threejs.js"></script>
```
